...
class ProductPayloadGenerator2:
        ...
        for field_name, field_info in api_model.model_fields.items():
            ...
            if elm_type is str or (str in get_args(elm_type) and type(None) in get_args(elm_type)):
                if field_name in ('name', 'description'):
                    generated = ProductPayloadGenerator2.fake.catch_phrase()
                ...
                generated = random.choice([
                    ProductPayloadGenerator2.fake.catch_phrase(),
                    None
                    ])
            elif bool in args:
                generated = random.choice([
                ...
                generated = ProductPayloadGenerator2.collect_products_data_2(elm_type)
            else:
                generated = None
...
p = ProductPayloadGenerator2.collect_products_data_2(CreateProductRequest)
print(p)
print("\nProductByIdResponse")
p = ProductPayloadGenerator2.collect_products_data_2(ProductByIdResponse)
print(p)
print("\nProductByIdResponse")
